...
import 'package:cryptome/features/authentication/presentation/widgets/agreement_widget.dart';
import 'package:cryptome/features/authentication/presentation/widgets/avatar_widget.dart';
import 'package:cryptome/features/authentication/presentation/widgets/option_widget.dart';
...
class _RegistationScreenState extends State<RegistationScreen> {
  ...
  List<String> keyPhraseParse(String keyPhraseString) {
    final normalizedString =
        keyPhraseString.replaceAll(RegExp(r'\s+'), ' ').trim();
